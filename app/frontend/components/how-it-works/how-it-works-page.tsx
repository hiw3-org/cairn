  ...
  <header className="sticky top-0 z-50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-lg">
    <nav className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
      ...
      <button
        ...
        className="text-sm font-semibold text-text-secondary hover:text-primary dark:text-text-dark-secondary dark:hover:text-primary-light"
      >
        Back to Home
      </button>
    </nav>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="relative isolate overflow-hidden text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-blue-200">
            Join CAIRN today. Start a project, fund groundbreaking science, and
            be part of the DeSci revolution.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <button
              onClick={() => login("metamask")}
              className="rounded-md bg-white px-4 py-2.5 text-sm font-semibold text-primary shadow-lg hover:bg-primary-light/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-transform hover:scale-105"
            >
              Enter the Platform
            </button>
          </div>
...
export const HowItWorksPage = ({
  ...
  const funderSteps = [
    ...
    },
    {
      ...
      description:
        "See the real-world impact of your funding through transparent, on-chain reporting.",
    },
  ];
  const coreConcepts = [
    {
    ...
    {
      icon: BeakerIcon,
      title: "Proof-of-Reproducibility",
      description:
        "Our novel on-chain mechanism for verifying scientific claims. Successful reproductions strengthen a project's impact score.",
    },
  ];
      ...
      <main>
        <section className="py-20 sm:py-24 text-center bg-background dark:bg-background-dark">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-text dark:text-text-dark tracking-tight">
              The CAIRN Workflow
            </h1>
            <p className="mt-4 max-w-2xl mx-auto text-lg text-text-secondary dark:text-text-dark-secondary">
              A transparent, step-by-step journey for researchers and funders on
              our decentralized science platform.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 sm:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold tracking-tight text-text dark:text-text-dark sm:text-4xl">
                A Researcher's Journey
              </h2>
              <p className="mt-4 text-lg text-text-secondary dark:text-text-dark-secondary">
                Follow these four steps to bring your research from an idea to a
                globally verifiable and fundable asset on the CAIRN platform.
              </p>
            </div>
            ...
            <div className="relative mt-20">
              ...
              <div
                className="hidden lg:block absolute top-12 left-0 w-full h-0.5 bg-border dark:bg-border-dark"
                aria-hidden="true"
              ></div>
        ...
        <section className="py-20 sm:py-24 bg-background dark:bg-background-dark">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-16 text-text dark:text-text-dark">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {funderSteps.map((step) => (
                <div
                  key={step.title}
                  className="text-center p-6 bg-background-light dark:bg-background-dark-light rounded-xl shadow-lg border border-border dark:border-border-dark"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {coreConcepts.map((concept) => (
                <div key={concept.title} className="flex items-start gap-4 p-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-text dark:text-text-dark">
                      {concept.title}
                    </h3>
