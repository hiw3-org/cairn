...
export const WalletIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 12m18 0v6a2.25 2.25 0 01-2.25-2.25H5.25A2.25 2.25 0 013 18v-6m18 0V9M3 12V9m18 3a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9m14.25 6.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" />
    </svg>
);

export const HypercertIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
...
export const StorageIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.35 3.836l-8.25 4.764 8.25 4.763 8.25-4.763-8.25-4.764z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.099 8.6l8.25 4.763v9.527l-8.25-4.763V8.6z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M21.9 8.6v9.527l-8.25 4.763v-9.527L21.9 8.6z" />
    </svg>
);

export const CopyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5-.124m7.5 10.375h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5.124" />
    </svg>
);
...
export const BeakerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3h14M8 3v4.586a1 1 0 01-.293.707l-4.414 4.414a1 1 0 00-.293.707V21h12v-7.586a1 1 0 00-.293-.707l-4.414-4.414A1 1 0 0116 7.586V3" />
    </svg>
);
...
export const UsersGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15c-2.625 0-4.875-1.375-6-3.375" />
    </svg>
);
...
export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 00-3-3m3 3a3 3 0 003-3m-3 3v5.25m9-5.25a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const UploadCloudIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.755 4.5 4.5 0 018.302-3.046a4.5 4.5 0 014.5 4.5v3.75m-16.5 0h16.5" />
    </svg>
);
...
export const GavelIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c.36.14.71.298 1.05.47V13.5a3 3 0 01-3 3h-1.5a3 3 0 01-3-3V6.557c.34-.172.69-.33 1.05-.47m4.5 0V4.5a1.5 1.5 0 00-1.5-1.5h-1.5a1.5 1.5 0 00-1.5 1.5v1.587m4.5 0c.36.14.71.298 1.05.47M9.75 6.087c.34-.172.69-.33 1.05-.47m-4.5 0V4.5a1.5 1.5 0 011.5-1.5h1.5a1.5 1.5 0 011.5 1.5v1.587m-4.5 0c-.36.14-.71.298-1.05.47m0 0L3 9.75l3.75 3.75M9.75 6.087L13.5 9.75l-3.75 3.75" />
    </svg>
);

export const ScaleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m0 0l-4.25-4.25M12 21l4.25-4.25M3 9l9-6 9 6M3 9v10.5A1.5 1.5 0 004.5 21h15a1.5 1.5 0 001.5-1.5V9" />
    </svg>
);
...
export const MetaMaskIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 80 80" fill="none" {...props}>
        ...
        <path fill="#E27625" d="M6.667 40c0 19.646 15.91 35.556 35.556 35.556 19.646 0 35.556-15.91 35.556-35.556H6.667z"/>
        <path fill="#E27625" d="M80 40c0-19.646-15.91-35.556-35.556-35.556C24.8 4.444 6.667 20.354 6.667 40H80z"/>
        <path fill="#F6851B" d="M42.222 4.444C22.576 4.444 6.667 20.354 6.667 40h71.111C77.778 20.354 61.869 4.444 42.222 4.444z"/>
        <path fill="#C0AD9E" d="M42.222 75.556c19.646 0 35.556-15.91 35.556-35.556H6.667c0 19.646 15.91 35.556 35.556 35.556z"/>
        <path fill="#763D16" d="M26.667 46.667L6.667 60l20-13.333zM57.778 46.667L77.778 60 57.778 46.667z"/>
        <path fill="#233447" d="M42.222 33.333L26.667 46.667h31.111L42.222 33.333z"/>
        <path fill="#E17726" d="M57.778 46.667L42.222 33.333 26.667 46.667h31.111z"/>
    </svg>
);
...
export const StarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.324l5.584.423a.563.563 0 01.31.958l-4.132 3.77a.563.563 0 00-.162.524l1.257 5.432a.563.563 0 01-.84.61l-4.93-2.92a.563.563 0 00-.528 0l-4.93 2.92a.563.563 0 01-.84-.61l1.257-5.432a.563.563 0 00-.162-.524l-4.132-3.77a.563.563 0 01.31-.958l5.584-.423a.563.563 0 00.475-.324l2.125-5.111z" />
    </svg>
);
...
export const ExternalLinkIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H21m0 0v7.5m0-7.5L13.5 13.5" />
  </svg>
);
...
export const HuggingFaceIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M20.24,6.27c-1.54-1.96-3.87-3.15-6.42-3.15s-4.88,1.19-6.42,3.15c-1.15,1.46-1.8,3.29-1.8,5.27s0.65,3.81,1.8,5.27c1.54,1.96,3.87,3.15,6.42,3.15s4.88-1.19,6.42-3.15c1.15-1.46,1.8-3.29,1.8-5.27S21.39,7.73,20.24,6.27z M12,18.57c-2.3,0-4.43-0.96-5.85-2.61c-0.34-0.4-0.1-1.02,0.34-1.22c0.44-0.2,1-0.03,1.2,0.41c1.07,1.23,2.6,1.95,4.3,1.95c1.71,0,3.23-0.72,4.3-1.95c0.2-0.44,0.76-0.6,1.2-0.41c0.44,0.2,0.68,0.82,0.34,1.22C16.43,17.61,14.3,18.57,12,18.57z M16.14,12.43c-0.2,0.44-0.76,0.6-1.2,0.41c-0.44-0.2-0.68-0.82-0.48-1.26c0.55-1.18,0.22-2.6-0.8-3.46c-1.01-0.86-2.43-0.98-3.57-0.31c-1.14,0.66-1.68,1.99-1.42,3.3c0.26,1.31,1.23,2.3,2.5,2.4c0.45,0.07,0.78,0.49,0.71,0.94c-0.07,0.45-0.49,0.78-0.94,0.71c-1.9-0.15-3.58-1.69-4-3.64C7.01,9.88,7.9,7.69,9.8,6.51c1.9-1.18,4.32-0.89,5.9,0.79C17.61,8.8,17.98,11.03,16.14,12.43z" />
    </svg>
);
...
export const CitationIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
