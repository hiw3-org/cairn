      ...
      case ProjectStatus.Draft:
        return (
          <button
            ...
            className="flex-1 bg-primary text-primary-text font-semibold py-2.5 px-4 rounded-lg hover:bg-primary-hover transition-all duration-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      case ProjectStatus.Reproducible:
        return (
          <button
            ...
            className="flex-1 bg-primary text-primary-text font-semibold py-2.5 px-4 rounded-lg hover:bg-primary-hover transition-all duration-300 text-sm"
          >
            Apply to Funding
          </button>
        );
      case ProjectStatus.Funded:
        const roundForProject = fundingRounds.find((r) =>
          r.applicants?.some((a) => a.projectId === project.id)
        );
        return (
          <button
            onClick={() =>
              roundForProject && onViewFundingRound(roundForProject)
            }
            disabled={!roundForProject}
            className="flex-1 bg-primary text-primary-text font-semibold py-2.5 px-4 rounded-lg hover:bg-primary-hover transition-all duration-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            View Round
          </button>
    ...
    <div className="bg-background-light dark:bg-background-dark-light rounded-xl shadow-md border border-border dark:border-border-dark overflow-hidden flex flex-col group transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-primary/30 dark:hover:border-primary/70">
      <div className="p-5 flex-grow">
        <div className="flex justify-between items-start mb-2">
          <h3 className="text-lg font-semibold text-text-primary dark:text-dark-text-primary pr-2">
            {project.title}
          </h3>
        ...
        <div className="mt-4 flex items-center space-x-6 text-sm">
          ...
          <div className="flex items-center space-x-2" title="Verified PoRs">
          ...
          <div className="flex items-center space-x-2" title="Funding Raised">
