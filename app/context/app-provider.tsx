...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const handleAddOutputs = (projectId: string, outputs: Output[]): Project => {
        ...
        if (wasDraftAndOwned) {
            ...
            addToast(`Project activated! Your PoR contribution quota has been reset.`, 'success');
        } else {
            ...
            <div className="p-4">
                <div className="flex items-start">
                    ...
                    <div className="ml-4 flex-shrink-0 flex">
                        <button onClick={onDismiss} className="rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
