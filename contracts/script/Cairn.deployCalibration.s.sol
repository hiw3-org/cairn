...
contract DeployCairn is Script {
    function run() external {
        ...
        address hypercertTokenAddress = vm.envAddress("CALIBRATION_HYPERCERT");
        address paymentTokenAddress = vm.envAddress("CALIBRATION_USDFC");

        uint8 minRequiredPoR = 0; // Minimum required proof of relevance (PoR) for a project
        uint8 maxPoRProject = 10;
        uint256 disputeWindowPoR = 5 minutes;
