...
async function createRepoSnapshot(repoPath) {
 ...
 */
async function runUpload(repoUrl) {
  ...
  try {
    ...
    await uploader.dlHuggingFaceRepo(repoUrl);
    const repoName = repoUrl.split("/").pop();
...
await createRepoSnapshot(
  "C:\\Users\\lukal\\Dev\\cairn\\helpers\\models\\detr-resnet-50"
);
